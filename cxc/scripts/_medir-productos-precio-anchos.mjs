// Ventas › Productos en los CUATRO anchos: 390 (iPhone), 834 (iPad parado —
// el ancho del medio, el que nadie mira), 1024 (iPad ACOSTADO) y 1440.
//
...
// origin/main y se exige que NO EMPEORE. Una columna más no puede agregar
// arrastre nuevo.
//
// Mide, en cada ancho:
...
//
// Solo lectura.
//   BASE=http://localhost:3214 ETAPA=antes node scripts/_medir-productos-precio-anchos.mjs
...
for (const ANCHO of ANCHOS) {
  ...
  try {
    ...
    await page.screenshot({ path: path.join(SALIDA, `productos-${ETAPA}-${ANCHO}.png`), fullPage: true });
