...
## Lo que decía CLAUDE.md hasta el 25-sep-2026 (movido acá, verbatim)

> Poda del 25-sep-2026, para que `cxc/CLAUDE.md` vuelva a caber bajo su tope.
> Son los dos bloques de **Sync, clasificación y puertas** y de **Plantilla Switch
> (era el Depurador)**, tal cual estaban. **Ninguna regla cambió**: lo único que
> cambió es dónde está escrita. En `CLAUDE.md` quedan dos líneas que apuntan acá.
...
### Las cuatro reglas del 22-sep-2026 podadas el 25-sep (verbatim)
