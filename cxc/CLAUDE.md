...
| Notas y contactos por cliente de CXC | `cxc_client_overrides` · `cxc_contact_log` · `cxc_emails_enviados` | 1 fila por (cartera, cliente normalizado) | La **cartera va en la llave**: el mismo nombre en dos empresas son dos filas. ⚠️ `cxc_favorites` sigue existiendo pero **sin un solo lector** desde el 4-sep-2026 (ver *Soft delete*). |
