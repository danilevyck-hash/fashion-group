...
> ### Medición
>
> **`BASE=… node scripts/_medir-cotizacion-anchos.mjs`** (el navegador **ABORTA cualquier POST** a `/api/catalogo/checkout` y a `**/enviar-switch`: abrir la elección no manda nada por diseño, y así es imposible aunque el diseño cambie). Contra el build de producción y con datos reales, en **390 · 834 · 1024 · 1440**: la elección mide **448×381 px en los cuatro anchos** (crece hacia abajo, no ensancha) → **0 arrastre · 0 recorte · 0 táctil <44 px · 0 texto <12 px**, con las dos opciones y la advertencia a la vista en los cuatro. Escrituras bloqueadas: **0**.
