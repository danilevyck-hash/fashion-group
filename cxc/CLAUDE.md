...
- 🔴 **EL NÚMERO GRANDE ES RETAIL Y TODO % ES RETAIL CONTRA RETAIL** (`RETAIL_AL_FRENTE`, `lib/multifashion/retail-al-frente.ts`, hoy `true`): 🩸 cuatro RPC leían ene–abr 2025 de `ventas_raw` (mayoreo SIN marcar) y el año decía «+8 %» siendo **+15,8 %**, abril «▼ 29 %» siendo **+10,5 %**, el bono de abril $50→$100 y junio $100→$50. Las versiones nuevas (`overview_serie_v2` · `proyeccion_cierre_v2` · `detalle_mensual_v3` · `bonos_v5` · `retail_recurrentes_v3`, migraciones `20261217140000` y `20261217140100`, **aplicadas**) leen SOLO la vista; el código cae a las viejas (`rpc-retail.ts`). La línea chiquita «+ $X de mayoreo (N facturas) · entró $Y» sale SOLO con mayoreo ≠ 0 (año, mes, Telegram); **en Productos nunca**.
