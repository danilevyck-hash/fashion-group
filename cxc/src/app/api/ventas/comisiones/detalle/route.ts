/**
 * Reporte detallado de comisión por vendedor (RPC comision_b2b_detalle).
 * Mismos filtros que comision_b2b_v3, a nivel documento (ventas + cobros).
 */
...
export async function GET(req: NextRequest) {
  ...
  const { data, error } = await supabaseServer.rpc("comision_b2b_detalle", {
