                ...
                <div key={`${item.product_id}-${idx}`} className="flex items-center gap-3 px-3 py-2.5">
                  <div className="flex-1 min-w-0">
                    ...
                    <p className="text-[11px] text-gray-400">
                      {item.sku} · {item.quantity * bs} pzas
                    </p>
                  </div>
                  <div className="flex items-center gap-1">
                    <button
                  ...
                  <div className="text-right w-20">
                    <p className="text-sm font-semibold text-gray-900 tabular-nums">
                      ${fmtMoney(item.unit_price)}<span className="text-[10px] font-normal text-gray-400">/u</span>
                    </p>
                    <p className="text-[11px] text-gray-400 tabular-nums">${fmtMoney(lineTotal)}</p>
                  </div>
                  <button
