...
/* ─────────────────────────────────────────────────────────────────────────────
 * 🩸 LA PESTAÑA «MARCACIONES» DE ANTES — chips por persona y por día, y una
 * tabla de seis columnas SIN fecha (25-sep-2026, por la mañana).
 *
 * Se conserva ENTERA detrás de `MARCACIONES_POR_DIA = false`: es lo que vuelve
 * a salir si Daniel dice que la pantalla agrupada por día no le sirve. Apagar
 * un interruptor no puede pedir escribir código de nuevo.
 *
 * Lo que la reemplazó y por qué está en `lib/asistencia/marcaciones-por-dia.ts`.
 *
 * ── LO QUE DECÍA ESTE ARCHIVO CUANDO ERA LA PANTALLA ────────────────────────
 *
...
export default function MarcacionesDeAntes({ empresa }: { empresa: string }) {
