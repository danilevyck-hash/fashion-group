...
function JoybeesCatalog() {
  ...
  // Checkout único (rediseño 5-jul): el pedido se crea, se le asigna cliente/
  // vendedor y se envía a Switch en /catalogo/joybees/checkout. Mueren el
  // "Crear pedido en el sistema" (modal de nombre) y el envío del carrito por
  // WhatsApp del flujo logueado (el catálogo PÚBLICO conserva su WhatsApp).
  function goCheckout() {
    if (cart.length === 0) return;
    router.push("/catalogo/joybees/checkout");
  }
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        <div className="flex items-start justify-between">
          ...
          {cartCount > 0 && (
            <button
              onClick={goCheckout}
              className="flex items-center gap-1.5 text-xs font-semibold text-[#404041] bg-[#FFE443] hover:bg-[#f5d90a] transition px-3 py-2 rounded-lg min-h-[44px]"
            >
