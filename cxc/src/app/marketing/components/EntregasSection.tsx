          ...
          {entregas.map((e) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span className="text-[10px] uppercase tracking-wider px-1.5 py-0.5 rounded bg-blue-50 text-blue-700 border border-blue-200 font-semibold">
                    Entrega
                  </span>
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-xs text-gray-500">
                      {Object.keys(e.total_por_marca ?? {}).length}{" "}
                      {Object.keys(e.total_por_marca ?? {}).length === 1
                        ? "marca"
                        : "marcas"}
                    </div>
                  </div>
