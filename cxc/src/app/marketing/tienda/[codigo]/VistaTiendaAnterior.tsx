...
// ============================================================================
// LA VISTA DE UNA TIENDA DE ANTES (22-sep-2026) — vive detrás del interruptor.
//
// 🔴 Desde el 23-sep-2026 (Tiendas y Marcas) la ficha es UNA lista
// (`FichaTienda.tsx`); esta pantalla —una tabla por marca, sin editar ni
// anular— se dibuja SOLO con `MARKETING_TIENDAS_Y_MARCAS` en `false`. Quién
// entra lo decide `VistaTienda.tsx`, que es el único que llama `useAuth`.
//
...
export default function VistaTiendaAnterior({ codigo }: { codigo: string }) {
