      ...
      <div className="flex flex-col sm:flex-row gap-6">
        ...
        {!editing && (
          <div className="flex sm:flex-col gap-2">
            <button
              onClick={(e) => { e.stopPropagation(); setWaSending(true); onOpenWhatsApp(client); onMarkContacted(client.nombre_normalized, "whatsapp"); setTimeout(() => setWaSending(false), 3000); }}
