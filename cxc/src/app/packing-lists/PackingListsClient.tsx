...
export interface PackingListsInitialData {
  plList: PLRecord[];
}
...
export default function PackingListsClient({ initialData }: { initialData: PackingListsInitialData }) {
  ...
  // State
  const [plList, setPlList] = useState<PLRecord[]>(initialData.plList);
  ...
  // Skipear primer mount cuando ya tenemos initialData del SSR.
