...
export default function FotoBadge({ count, className = "" }: FotoBadgeProps) {
  ...
  return (
    <span
      ...
      className={`inline-flex items-center gap-1 rounded-full bg-gray-100 text-gray-500 text-[10px] font-medium leading-none px-1.5 py-0.5 tabular-nums align-middle ${className}`}
    >
