...
const MODULE_ICONS: Record<string, React.ReactNode> = {
  ...
  joybees: <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4z"/><line x1="3" y1="6" x2="21" y2="6"/><path d="M16 10a4 4 0 01-8 0"/></svg>,
...
const ALL_MODULES = [
  ...
  { key: "joybees", label: "Catálogo Joybees", subtitle: "Clogs, sandalias y más", href: "/catalogo/joybees", roles: ["admin", "vendedor"], group: "catalogo" as const },
