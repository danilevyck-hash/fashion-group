...
export function recordatorioVacio(fecha?: string): RecordatorioFormValues {
  return {
...
export default function RecordatorioFormModal({
  ...
  const falta = faltaParaGuardar(v);
  ...
  return (
    <ModalOverlay onBackdropClick={intentarCerrar}>
      ...
      >
        ...
        {falta.length > 0 && (
          <p className="px-5 pb-3 -mt-1 text-xs text-amber-700 bg-white">
            Falta: {falta.join(" y ")}
          </p>
        )}
      </div>
