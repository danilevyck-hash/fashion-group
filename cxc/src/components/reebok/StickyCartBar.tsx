...
export default function StickyCartBar({
  ...
  const defaultActionColor = variant === "public" ? "bg-[#25D366] hover:bg-[#1fb855]" : "bg-[#E4002B] hover:bg-[#c90025]";
  ...
  function handleAction() {
    if (variant === "public" && onSendWhatsApp) {
      onSendWhatsApp();
    ...
    >
      ...
      >
        ...
        <div className="px-4 py-2.5 border-t border-gray-100 flex items-center justify-between">
          <span className="text-sm font-bold text-[#1A2656]">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="text-xs text-gray-400 hover:text-[#E4002B] transition"
            >
              Vaciar
            </button>
          </div>
      ...
      <div className="p-3 bg-white border-t border-gray-100 shadow-[0_-4px_20px_rgba(0,0,0,0.08)] flex items-center gap-2" style={{ paddingBottom: "max(12px, env(safe-area-inset-bottom))" }}>
        ...
        <button
          ...
          className="flex items-center gap-2 px-3 py-3.5 rounded-xl bg-[#F5F0E8] text-[#1A2656] text-sm tabular-nums shrink-0 hover:bg-[#ebe5d9] transition min-h-[56px]"
        >
          {/* Cart icon */}
