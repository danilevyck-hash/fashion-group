...
// ============================================================================
// LAS PIEZAS DE VENTAS EN EL CELULAR (25-sep-2026).
//
// Las tres pestañas del mockup que Daniel aprobó se dibujan con las mismas
// cinco piezas de iOS: el título grande, la tira de cuatro números (1b), la
// tabla compacta (2a), la fila de dos renglones con su % grande (3f) y la hoja
// que sube desde abajo (6a). Viven acá para que las tres se lean como la misma
// app y para que un cambio de aire se haga en un solo lugar.
//
// 🔴 NINGUNA DE ESTAS PIEZAS CALCULA NADA: reciben texto ya escrito por
// `lib/ventas/celular.ts` (puro) y lo dibujan.
// ============================================================================
...
export function RotuloVentas({ children }: { children: ReactNode }) {
  return (
...
export function GrupoVentas({ children, className = "" }: { children: ReactNode; className?: string }) {
  return (
