...
function UtilidadRow({ r }: { r: UtilidadClienteRow }) {
  ...
  return (
    <tr className="border-b border-gray-100 hover:bg-gray-50">
      ...
      <td className="hidden px-3 py-2.5 text-gray-500 sm:table-cell">{r.empresa}</td>
      <td className="px-3 py-2.5 text-right font-mono tabular-nums text-gray-700">{fmtMoneySigned(r.ventas)}</td>
      <td className="hidden px-3 py-2.5 text-right font-mono tabular-nums text-gray-500 md:table-cell">{fmtMoneySigned(r.costo)}</td>
