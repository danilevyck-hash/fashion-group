...
function CumulativeTooltip({
  ...
  return (
    <div className="rounded-md border border-gray-200 bg-white px-3 py-2 text-xs shadow-sm">
      <p className="mb-1.5 font-medium text-gray-700">{MONTH_ABBR[mes]}</p>
      <div className="grid grid-cols-[auto_auto_auto] gap-x-3 gap-y-0.5">
        <span />
        <span className="text-right text-xs uppercase tracking-wide text-gray-400">Mes</span>
        <span className="text-right text-xs uppercase tracking-wide text-gray-400">Acum.</span>
