...
export const ALL_MODULES: AppModule[] = [
  ...
  { key: "marketing",     label: "Marketing",             subtitle: "Gastos compartidos a marcas",        href: "/marketing",       icon: "M3 11l18-8v18L3 13z M11 19a3 3 0 01-6 0v-6 M18 8v8",                            roles: ["admin", "secretaria", "director"],                        group: "dia" },
